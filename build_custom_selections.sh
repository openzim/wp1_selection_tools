...
then
    ...
    echo "Wikipedia:Books/archive/Cardiology" >> "$CUSTOM_DIR/medicine.tsv"
    echo "Wikipedia:Books/archive/Children's health" >> "$CUSTOM_DIR/medicine.tsv"
    echo "Wikipedia:Books/archive/Dermatology" >> "$CUSTOM_DIR/medicine.tsv"
    echo "Wikipedia:Books/archive/Ears_nose_throat" >> "$CUSTOM_DIR/medicine.tsv"
    echo "Wikipedia:Books/archive/Endocrine_disease" >> "$CUSTOM_DIR/medicine.tsv"
    echo "Wikipedia:Books/archive/Eye_diseases" >>  "$CUSTOM_DIR/medicine.tsv"
    echo "Wikipedia:Books/archive/Heart_disease" >>  "$CUSTOM_DIR/medicine.tsv"
    echo "Wikipedia:Books/archive/Gastroenterology" >> "$CUSTOM_DIR/medicine.tsv"
    echo "Wikipedia:Books/archive/General_surgery" >> "$CUSTOM_DIR/medicine.tsv"
    echo "Wikipedia:Books/archive/Infectious_disease" >> "$CUSTOM_DIR/medicine.tsv"
    echo "Wikipedia:Books/archive/Medications" >> "$CUSTOM_DIR/medicine.tsv"
    echo "Wikipedia:Books/archive/Mental_health" >>  "$CUSTOM_DIR/medicine.tsv"
    echo "Wikipedia:Books/archive/Neurology" >> "$CUSTOM_DIR/medicine.tsv"
    echo "Wikipedia:Books/archive/Ortho" >> "$CUSTOM_DIR/medicine.tsv"
    echo "Wikipedia:Books/archive/Orthopedics" >> "$CUSTOM_DIR/medicine.tsv"
    echo "Wikipedia:Books/archive/Cancer_care" >> "$CUSTOM_DIR/medicine.tsv"
    echo "Wikipedia:Books/archive/Ophthalmology" >> "$CUSTOM_DIR/medicine.tsv"
    echo "Wikipedia:Books/archive/Pediatrics" >> "$CUSTOM_DIR/medicine.tsv"
    echo "Wikipedia:Books/archive/Psychiatry" >> "$CUSTOM_DIR/medicine.tsv"
    echo "Wikipedia:Books/archive/Rheumatology" >> "$CUSTOM_DIR/medicine.tsv"
    echo "Wikipedia:Books/archive/Skin_diseases" >> "$CUSTOM_DIR/medicine.tsv"
    echo "Wikipedia:Books/archive/Women's_health" >> "$CUSTOM_DIR/medicine.tsv"
